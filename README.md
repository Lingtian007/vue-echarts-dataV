...
- 一个基于 Vue、Datav、Echart 框架的 " **数据可视化大屏项目** "，通过 Vue 组件实现数据动态刷新渲染，内部图表可实现自由替换。部分图表使用 DataV 自带组件，可进行更改，详情请点击下方 DataV 文档。
- 项目需要全屏展示（按 F11）。
...
4.   ![效果图:](https://github.com/Lingtian007/vue-echarts-dataV/blob/main/src/assets/%E5%9B%BE.png)
